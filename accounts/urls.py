...
urlpatterns = [
    ...
    path('profile/<str:organisation_name>/', profile_view, name='profile'),
    path('profile/<str:organisation_name>/events/', include('events.urls')),
    ...
    path('password_reset/', auth_views.PasswordResetView.as_view(
            template_name='register/request_password_reset.html',
            success_url=reverse_lazy('accounts:password_reset_done'),
            from_email=EMAIL_HOST_USER,
            email_template_name='register/password_reset_email.html',
            subject_template_name='register/password_reset_email_subject.txt'
        ), name='password_reset'),
    path('password_reset/done/', auth_views.PasswordResetDoneView.as_view(
            template_name='register/request_password_reset_done.html'
